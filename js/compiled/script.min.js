...
ZANDER.ui = {
    ...
    shotSwitch: function() {
        ...
        var regex = /(shot-[0-9])/g, regexNoNumber = /(shot-)/g;
        $("#main").on("click", ".layout-desktop-three-up figure", function(event) {
            var $this = $(this), $allSiblings = $this.siblings(".shot-visible").andSelf(), allSiblingsCount = $allSiblings.length - 1;
            ...
            if ($this.hasClass("shot-1")) {
                ...
                $allSiblings.each(function(i) {
                    ...
                    log("number: " + number);
                    var className = "shot-" + i, incClassName;
    ...
    shotHeight: function() {
        $("#main").on("click", ".layout-stacked figure", function(event) {
            var $parent = $(this).parent(), $shotHeight = $parent[0].scrollHeight;
            log($parent);
            log($shotHeight);
            if ($parent.hasClass("is-expanded")) {
                $parent.removeClass("is-expanded").parent().css("paddingBottom", 0);
            } else {
                $parent.addClass("is-expanded").parent().css("paddingBottom", "4%");
            }
        });
    }
};
